<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="#"><i class="fa fa-table"></i> Reports</a>
					<ul>
						<li><a href="occupancy.php">Rooms occupancy</a></li>
						<li><a href="stdt.php">Students</a></li>
						<li><a href="fees.php">Fees</a></li>
						<li><a href="notice-report.php">Notice Report</a></li>
					</ul>
				</li>
				...
				<li><a href="notice.php"><i class="fa fa-bullhorn"></i>Notices</a></li>
				<li><a href="chat.php"><i class="fa fa-paper-plane"></i>Chats</a></li>
